...
def _download_artifact(url, filename):
    ...
    https://github.com/actions/download-artifact/issues/290#issuecomment-1935024240
    ghapi fails to pass the correct headers for downloading artifacts from the v4 API
